...
public class Bill {
    ...
    public void Bill1() {
        ...
        f.getContentPane().setBackground(Color.DARK_GRAY); // dark frame background
        panel.setBackground(Color.BLACK); // dark panel
        ...
        JLabel jl=new JLabel("Generate Bill");
        ...
        JButton[] buttons = {b4,b5,b6,b7,b8,b9};
        ...
        receiptList.setBackground(Color.BLACK);
        receiptList.setForeground(Color.WHITE);
        receiptList.setCaretColor(Color.WHITE);
        ...
        try {  
            ...
            Class.forName(MySQLConnection.forNameClassVar);  //jdbc 4.0 onwards doesnt require this as DriverManager automatically manages this
            ...
            public void actionPerformed(ActionEvent e){  
                if(tf.getText().isEmpty()||tf2.getText().isEmpty()) {
                    ...
                    if(availableQuantity>=requiredQuantity) {
                        if(pannelSize.getText().isEmpty()) { i++; }
                        else { i=1; pannelSize.setText(""); }

                        if(i==1) { sample.setText(LocalDateTime.now().toString()); }
                        ...
                        try{
                            ...
                            Class.forName(MySQLConnection.forNameClassVar);
                            Connection orderconn = MySQLConnection.DBConn();
                            Statement st = orderconn.createStatement();
                            st.executeUpdate(
                        ...
                        try{
                            PreparedStatement pst = null;
                            Class.forName(MySQLConnection.forNameClassVar);
                            Connection quantityconn = MySQLConnection.DBConn();
                        ...
                        try{  
                            ...
                            model.setRowCount(0);
                            Class.forName(MySQLConnection.forNameClassVar);
                            Connection productcon = MySQLConnection.DBConn();  
                        ...
                        if(i==1) {
                            receiptList.setText("\n                        GREEN ENERGY Ltd.             \n ");
                            receiptList.append("\n  ******************************************************\n ");
                            receiptList.append("                          Payment Receipt                   \n ");
                            receiptList.append(" ******************************************************\n ");
                            receiptList.append("  Receipt Date : "+ date +"\n ");
                            receiptList.append(i+"      "+tf.getText()+"        "+price+"        "+requiredQuantity+"        "+ productPrice+"\n");
                            diw.setText(Integer.toString(productPrice));
                        } else {
                            receiptList.append(i+"      "+tf.getText()+"        "+price+"        "+requiredQuantity+"        "+ productPrice+"\n");
                            int totalprice=Integer.parseInt(diw.getText());
                            int finalAmount=totalprice+productPrice;
                            diw.setText(Integer.toString(finalAmount));
                        }
                    } else {
        ...
        b8.addActionListener(new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
                int totalprice=Integer.parseInt(diw.getText());
                diw.setText(Integer.toString(totalprice));
                receiptList.append("  ------------------------------------------------------------------------\n ");
                receiptList.append("  Total Price : \t\t"+"₹"+ diw.getText() +"\n ");
                receiptList.append("======================================================\n ");
                receiptList.append("             !!! Thank You,Visit Again !!!               \n ");
            }  
        });
        ...
        b7.addActionListener(new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
                try {
                    ...
                    Color originalBg = receiptList.getBackground();
                    Color originalFg = receiptList.getForeground();

                    // Temporarily set background white and text black for printing
                    receiptList.setBackground(Color.WHITE);
                    receiptList.setForeground(Color.BLACK);

                    receiptList.print();

                    // Restore original dark colors
                    receiptList.setBackground(originalBg);
                    receiptList.setForeground(originalFg);
