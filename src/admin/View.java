...
public class View {
    ...
    public static void View11() {
        JFrame frame = new JFrame("GoGreen - Items");
        ...
        // Header
        JLabel header = new JLabel("ITEM LIST", SwingConstants.CENTER);
        ...
        // Apply custom renderer for all columns
        ...
        try (Connection con = MySQLConnection.DBConn();
            ...
            adjustRowHeights(table); // Adjust row heights after loading all data
        } catch (Exception e) {
            JOptionPane.showMessageDialog(frame, "Error loading items: " + e.getMessage(),
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(View::View11);
    }
}
